...
def handleHttp(dict_param: dict):
    ...
    登陆应该传递的参数有用户名相关的信息
    """
    testUrl = "https://paapistg.oreo88.com/b2b/player/account/my-bets-full"
    ...
    dictBody = {}
    dictBody["loginId"] = "probet.test0003"
    ...
    objRsp.data.loginUrl = dictDataInfo["loginUrl"]
    objRsp.data.updateDate = dictDataInfo["updateDate"]
