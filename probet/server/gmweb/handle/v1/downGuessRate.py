...
def handleHttp(dict_param:dict):
    ...
    iDownRate = float(dict_param["strDownRate"])
    ...
    if objGuessData is not None:
        ...
        if objCTR is None:
            ...
            if True:#objGuessData.iFixReturnRate != 0:
                ...
                objCTR.fRate = float("%.2f"%round(objCTR.fRate - abs(objCTR.fRate - 1) * iDownRate,2))
                    ...
                    if var_ctr_key == strChooseId:
                        ...
                        if var_ctr_value.fRate <= 1.0:
                            ...
                            raise exceptionLogic([errorLogic.guess_return_rate_fixUpDownRateFailed_Less1Value.value[0],
                                               errorLogic.guess_return_rate_fixUpDownRateFailed_Less1Value.value[1].format(var_ctr_key)])
